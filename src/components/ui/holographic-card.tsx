...
const HolographicCard: FC<HolographicCardProps> = ({
  ...
  return (
    <div
      ref={wrapRef}
      className={`hc-wrapper h-full ${className}`}
    >
      <div
        ref={cardRef}
        className="hc-card w-full h-full"
        onPointerEnter={handlePointerEnter}
        onPointerMove={handlePointerMove}
        onPointerLeave={handlePointerLeave}
      >
        <div className="hc-inside w-full h-full">
          <div className="hc-shine" />
          <div className="hc-glare" />
          <div className="hc-content-wrapper w-full h-full">
            {children}
          </div>
        </div>
      </div>
